    ...
    parser: parser.configure({
        props: [
            styleTags({
                ...
                ".": t.derefOperator,
                ",": t.separator,
                "LogicOpNot LogicOpAnd LogicOpOr": t.logicOperator,
                "CompareOpIn CompareOpNotIn CompareOpMatches CompareOpContains CompareOpStartsWith CompareOpEndsWith": t.compareOperator,
                '"=="': t.compareOperator,
                '"!="': t.compareOperator,
                '"<"': t.compareOperator,
                '"<="': t.compareOperator,
